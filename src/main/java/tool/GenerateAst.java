...
public class GenerateAst {
        ...
        var expr = new TreeMap<String, List<String>>() {
            {
                ...
                put("Call", List.of("Expr callee", "Token paren", "java.util.List<Expr> arguments"));
        ...
        var stmt = new TreeMap<String, List<String>>() {
            {
                ...
                put("Return", List.of("Token keyword", "Expr value"));
    ...
    private static void createAst(
            Path path, String baseName, Map<String, List<String>> definitions, boolean hasReturn)
        throws Exception {
    ...
    private static void buildAstVisitor(
            Formatter formatter, String baseName, Map<String, List<String>> definitions, boolean hasReturn)
        throws Exception {
    ...
    private static void buildAstDefinition(
            Formatter formatter, String baseName, Map.Entry<String, List<String>> definition, boolean hasReturn)
        throws Exception {
